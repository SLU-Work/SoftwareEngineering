            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.my_plan:
                        ...
                        mNavigationController.showView(NavigationScreens.MY_PLAN);
                        break;
                    case R.id.my_places:
                        Log.d("NAVIGATION", "Search Option Selected");
                        mNavigationController.showView(NavigationScreens.MY_PLACES);
                        break;
                    case R.id.explore:
                        Log.d("NAVIGATION", "Settings Option Selected");
                        mNavigationController.showView(NavigationScreens.EXPLORE);
                        break;
                    case R.id.user_profile:
                        Log.d("NAVIGATION", "Settings Option Selected");
                        mNavigationController.showView(NavigationScreens.USER_PROFILE);
                        break;
                    case R.id.user_contacts:
                        Log.d("NAVIGATION", "Settings Option Selected");
                        mNavigationController.showView(NavigationScreens.USER_CONTACTS);
                        break;
                }
